...
class Blog extends Component {
  ...
  getBlogItems() {
    ...
    axios
      .get(`https://rajijohnson06.devcamp.space/portfolio/portfolio_blogs?page=${this.state.currentPage}`, {
        withCredentials: true
      })
      .then(response => {
        ...
        return (
          <div key={blogItem.id} className="admin-blog-wrapper">
            ...
            <a onClick={() => this.handleDeleteClick(blogItem)}>
              <FontAwesomeIcon icon="trash" shake />
            </a>
          </div>
        );
      } else {
      ...
      <div className="blog-container">
        ...
        {this.props.loggedInStatus === "LOGGED_IN" ? (
          <div className="new-blog-link">
            <a onClick={this.handleNewBlogClick}><FontAwesomeIcon icon="plus-circle" beatFade /></a>
          </div>
        ) : null}
